...
@section('container')
    <div class="card-body">
        ...
        <form action="{{ url('dokumentasi/' . $dokumentasi->id) }}" method="post" class="w-2/3 mx-auto"
            ...
            <label class="form-control w-full ">
                ...
                <input type="text" placeholder="Type here" name="nama" value="{{ @old('nama', $dokumentasi->nama) }}"
            ...
            <label class="form-control w-full ">
                ...
                <textarea class="textarea textarea-primary" name="keterangan" placeholder="Type here" rows="4" cols="50">{{ @old('keterangan', $dokumentasi->keterangan) }}</textarea>
            ...
            <label class="form-control w-full ">
                ...
                <textarea class="textarea textarea-primary" name="link_gdrive" placeholder="Type here" rows="4" cols="50">{{ @old('link_gdrive', $dokumentasi->link_gdrive) }}</textarea>
