...
@section('container')
    <div class="container mx-auto py-5">
        <div class="card bg-base-100 w-full shadow-xl mx-auto">
            ...
            <div class="card-body">
                <h2 class="card-title mx-auto">Edit Pendaftaran</h2>
            </div>

            <div class="card-body">
                <form action="{{ url('pendaftaran/' . $pendaftaran->id) }}" method="post" enctype="multipart/form-data"
                    ...
                    <label class="form-control w-full ">
                        ...
                        <input type="number" placeholder="Type here" name="no_wa"
                            value="{{ @old('no_wa', $pendaftaran->no_wa) }}"
                    ...
                    <div class="flex mt-4 gap-4">
                        <a class="btn btn-primary" href="{{ url('/pendaftaran') }}">Kembali</a>
