...
@section('container')
    <div class="card-body">
        ...
        <div class="overflow-x-auto">
            ...
            <a href="{{ url('pengurus/create') }}" class="btn btn-primary mb-5">Tambah</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex gap-4">
                                    <a href="{{ url('pengurus/' . $item->id . '/edit') }}"
                                    ...
                                    <dialog id="my_modal_4{{ $item->id }}" class="modal">
                                        <div class="modal-box w-11/12 max-w-3xl">
                                            <h3 class="text-lg font-bold">Anda akan menghapus data pengurus!
                                                {{ $item->judul }} !</h3>
                                            <div class="modal-action">
                                                <form method="post" action="{{ url('pengurus/' . $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
