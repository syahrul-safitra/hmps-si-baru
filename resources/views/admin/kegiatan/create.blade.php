...
@section('container')
    <div class="card-body">
        ...
        <form action="{{ url('kegiatan') }}" method="post" class="w-2/3 mx-auto" enctype="multipart/form-data">
            @csrf
            ...
            <label class="form-control w-full ">
                ...
                <textarea class="textarea textarea-primary" name="deskripsi" placeholder="Type here" rows="4" cols="50"></textarea>
