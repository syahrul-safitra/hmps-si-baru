...
@section('container')
    <div class="card-body">
        ...
        <h2 class="card-title"><a class="btn btn-sm btn-primary  my-3" href="{{ url('kegiatan/create') }}">Tambah</a></h2>
        <div class="overflow-x-auto">
            <table class="display" id="example" style="witdh:100%">
                <!-- head -->
                <thead>
                    <tr>
                        <th style="color:black">No</th>
                        <th style="color:black">Nama</th>
                        <th style="color:black">Waktu Mulai</th>
                        <th style="color:black">Waktu Akhir</th>
                ...
                <tbody>
                    ...
                    @foreach ($kegiatans as $item)
                        ...
                        <tr>
                            ...
                            <td>
                                {{ date('d-m-Y - H:i', strtotime($item->tanggal_waktu_mulai)) }}
                            </td>
                            <td>
                                {{ date('d-m-Y - H:i', strtotime($item->tanggal_waktu_akhir)) }}
                            </td>
                            <td>
                                {{ $item->tempat }}
                            </td>
                            ...
                            <th>
                                <div class="avatar">
                                    <div class="mask mask-squircle h-12 w-12">
                                        <img src="{{ asset('berkas/' . $item->thumbnail) }}"
